...
> **Kimi adapter:** Load via the Kimi Skill tool or place in your Kimi skills directory. Source: [`../../.claude/skills/persona-simulation-testing/SKILL.md`](../../.claude/skills/persona-simulation-testing/SKILL.md).
