...
> **Kimi adapter:** Load via the Kimi Skill tool or place in your Kimi skills directory. Source: [`../../.claude/skills/task-identification-extraction/SKILL.md`](../../.claude/skills/task-identification-extraction/SKILL.md).
