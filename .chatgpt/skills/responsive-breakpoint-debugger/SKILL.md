...
> **ChatGPT adapter:** Use the markdown below as the custom GPT / system instructions. Source: [`../../.claude/skills/responsive-breakpoint-debugger/SKILL.md`](../../.claude/skills/responsive-breakpoint-debugger/SKILL.md).
