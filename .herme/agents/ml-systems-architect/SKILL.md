...
> **Hermes adapter:** Use `system.md` as the system message for Hermes-based local LLMs (Ollama, lm-studio, etc.). Source: [`../../.claude/skills/ml-systems-architect/SKILL.md`](../../.claude/skills/ml-systems-architect/SKILL.md).
