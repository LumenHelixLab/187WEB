...
> **Hermes adapter:** Use `system.md` as the system message for Hermes-based local LLMs (Ollama, lm-studio, etc.). Source: [`../../.claude/skills/tone-adjustment-polishing/SKILL.md`](../../.claude/skills/tone-adjustment-polishing/SKILL.md).
...
This skill injects the `tone-adjustment-polishing` directive from the 187web Master Prompt Manifest.
