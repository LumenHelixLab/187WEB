...
> **Hermes adapter:** Use `system.md` as the system message for Hermes-based local LLMs (Ollama, lm-studio, etc.). Source: [`../../.claude/skills/component-library-weaver/SKILL.md`](../../.claude/skills/component-library-weaver/SKILL.md).
...
This skill injects the `component-library-weaver` directive from the 187web Master Prompt Manifest.
